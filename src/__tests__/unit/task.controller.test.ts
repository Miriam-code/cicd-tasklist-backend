...
describe("TaskController", () => {
  ...
  describe("createTask", () => {
    ...
    it("should return 201 and create the task when the title is valid", async () => {
  ...
  describe("updateTask", () => {
    ...
    it("should return 500 for any other error", async () => {
      mockService.update.mockRejectedValue(new Error("Something else"));
      const req = createMockRequest({ params: { id: "1" }, body: { title: "Updated" } });
      const res = createMockResponse();
    ...
    it("should return 500 when a non-Error value is thrown", async () => {
      mockService.update.mockRejectedValue("plain string error");
      const req = createMockRequest({ params: { id: "1" }, body: { title: "Updated" } });
      const res = createMockResponse();
  ...
  describe("deleteTask", () => {
    ...
    it("should return 500 for any other error", async () => {
      mockService.remove.mockRejectedValue(new Error("Something else"));
      const req = createMockRequest({ params: { id: "1" } });
      const res = createMockResponse();
